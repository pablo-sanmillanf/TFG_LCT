...
class ClassifierView(QGraphicsView):
    ...
    def setup(self, x_padding: float | int, y_padding: float | int, min_width: float | int, min_height: float | int,
        ...
        self.split_action.triggered.connect(self._split)
        self.join_action.triggered.connect(self._join)
        self.promote_separator_action.triggered.connect(self._promote_separator)
        self.demote_separator_action.triggered.connect(self._demote_separator)
